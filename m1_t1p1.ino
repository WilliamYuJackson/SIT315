...
const int redLedMotionPin = 13; // Red LED Connects to the 13 (indication motion)
const int greenLedNoMotionPin = 12; // Green LED Connects to the 13 (indication No motion)
